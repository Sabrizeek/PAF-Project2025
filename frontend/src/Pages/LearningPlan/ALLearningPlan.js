...
function AllLearningPlan() {
  ...
  const renderPostByTemplate = (post) => {
    ...
    switch (post.templateID) {
      ...
      default:
        return <div className="template template-default"><p>Unknown template ID: {post.templateID}</p></div>;
    }
  };
        ...
        <div className='searchinput'>
          <input
            ...
            onChange={(e) => {
              ...
              setFilteredPosts(posts.filter((post) => post.postOwnerName.toLowerCase().includes(value.toLowerCase())));
            }}
